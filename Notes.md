...
To match length and mimic human p53 interactions, we can add 1–2 residues at the N- or C-terminus: M-ETFSYLWELLP-L

# 3. Check hydrophobic/polar positioning
MDM2 hotspots = Leu54, Leu57, Ile61, Tyr67, Phe91, Val93
Peptide design strategy:
- Hydrophobic residues (L, I, F, W) point toward hydrophobic pocket
- Polar residues (S, T, E) face solvent or form H-bonds
- Example final 13-residue peptide (elephant-inspired):

# METFSYLWELLPQ

- Hydrophobic residues: F, Y, L, W, L, L
- Polar residues: E, S, T, Q
